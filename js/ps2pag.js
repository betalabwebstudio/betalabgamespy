(function() {
    ...
    async function cargarProductos() {
        try {
            console.log('1. Intentando cargar JSON PS2Pag...');
            
            const respuesta = await fetch('json/ps2pag.json');
            ...
            document.getElementById('productosGridPS2PAG').innerHTML = `
    ...
    function mostrarProductos() {
        const grid = document.getElementById('productosGridPS2PAG');
        
        if (!grid) {
            console.error('No encontré el elemento productosGridPS2PAG');
            return;
        }
