(function() {
    ...
    async function cargarProductos() {
        try {
            console.log('1. Intentando cargar JSON gift...');
            
            const respuesta = await fetch('json/gift.json');
            ...
            document.getElementById('productosGridgift').innerHTML = `
    ...
    function mostrarProductos() {
        const grid = document.getElementById('productosGridgift');
        
        if (!grid) {
            console.error('No encontré el elemento productosGridgift');
            return;
        }
    ...
    document.addEventListener('DOMContentLoaded', () => {
        console.log('Página cargada, iniciando gift...');
        cargarProductos();
    });
})();