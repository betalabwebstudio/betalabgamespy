(function() {
    ...
    async function cargarProductos() {
        try {
            console.log('1. Intentando cargar JSON PS3Pag...');
            
            const respuesta = await fetch('json/giftpag.json');
            ...
            document.getElementById('productosGridPS3pag').innerHTML = `
    ...
    function mostrarProductos() {
        const grid = document.getElementById('productosGridgiftPAG');
        
        if (!grid) {
            console.error('No encontré el elemento productosGridPS3PAG');
            return;
        }
